...
public class Map {
    ...
    public void buildMap() {
        ...
        Room room2 = new Room("Room 2 ", "You enter a room, with dim lighting, theres some furniture as well as a grandiose canvas picturing a impressive looking mouse." +
                "\nThere are doors on either side of the room.");
        ...
        Room room4 = new Room("Room 4 ", "You enter a bedroom, with a large bed positioned in the middle. There are 2 doors on either side of the room.");
        ...
        room8.addEnemy(new Enemy("Cat" , " - " + "A dangerous kitty cat, with only one eye", claws, 100));
